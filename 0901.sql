...
--insert into 주문 values('o011', 'pear', 'p09', 20, '경기도 안양시', '2022-05-22');
...
-- 주문고객, 주문제품, 배송지, 주문일자를 주문테이블에서 조회(단, 주문고객은 고객아이디, 주문제품은 제품번호의 컬럼명으로 출력)
-- as 또는 공백문자
...
-- 고객 테이블에서 직업이 회사원이고 나이가 33세 미만인 고객의 고객아이디, 고객이름, 나이, 직업을 검색하시오.
